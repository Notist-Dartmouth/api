const data = [
  {
    ...
    description: 'Node.js® is a JavaScript runtime built on Chromes V8 JavaScript engine. Node.js uses an event-driven,' +
  ...
  { resource: 'Aphrodite for CSS',
    ...
    description: 'Support for colocating your styles with your JavaScript component. It is inline styles, but they work!',
  },
  {
  ...
  },
  {
    ...
    description: 'Webpack is a bundler for modules. The main purpose is to bundle JavaScript files for usage in a browser, yet it is also capable of transforming,' +
